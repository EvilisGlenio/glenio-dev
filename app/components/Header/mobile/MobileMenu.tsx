  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="bg-transparent hover:bg-gray-200 dark:text-gray-100 rounded-lg text-sm p-1.5 absolute top-2.5 end-2.5 inline-flex items-center dark:hover:bg-zinc-800 dark:hover:text-white"
